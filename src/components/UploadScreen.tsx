      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="w-16 h-16 rounded-full bg-surface-container-highest flex items-center justify-center group-hover:scale-110 transition-transform">
            <span className={`material-symbols-outlined text-4xl ${salesFile ? 'text-primary' : 'text-secondary'}`} data-icon="upload_file">upload_file</span>
          </div>
          <div className="text-center z-10">
            ...
            {salesFile ? (
              ...
              <p className="font-label-sm text-secondary">클릭하여 파일 찾기</p>
            )}
          </div>
        </div>
        ...
        >
          ...
          />
          <div className="w-16 h-16 rounded-full bg-surface-container-highest flex items-center justify-center group-hover:scale-110 transition-transform">
            <span className={`material-symbols-outlined text-4xl ${advFile ? 'text-primary' : 'text-secondary'}`} data-icon="upload_file">upload_file</span>
          </div>
          <div className="text-center z-10">
